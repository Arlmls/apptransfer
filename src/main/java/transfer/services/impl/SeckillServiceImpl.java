//package transfer.services.impl;
//
...
//
//import transfer.dao.SeckillDao;
//import transfer.dao.SuccessSeckilledDao;
//import transfer.dao.cache.RedisDao;
...
//import transfer.enums.SeckillStatEnum;
...
//
//	//加入一个混淆的字符串（秒杀接口）的salt，为了避免用户猜出我们的md5值，任意给，越复杂越好
//	private final String salt = "asd#%$^";
//	
//	@Autowired
...
//			if(seckill == null) {  //说明查不到这条秒杀产品的记录
...
//	}
//	
//	//秒杀是否成功，成功：点库存，增加明细；失败：抛出异常，事务回滚
//	@Transactional
//	/**
//	 * 使用注解控制事务方法的优点：
//	 * 1.开发团队达成一致约定，明确标注事务方法的编程风格
//	 * 2.保证事务方法的执行时间尽可能的短，最好不要穿插其他的网络操作RPC／HTTP请求或者剥离到事务方法的外部
...
//					SuccessSeckilled successSeckill = successSeckilledDao.queryByIdWithSeckill(seckillId,userPhone);
